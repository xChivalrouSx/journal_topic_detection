...
df = pd.read_csv(execution_directory + '\\test_data\\data_en_test.csv', error_bad_lines=False)
...
i = 0
for keywordsCommaSeperated in df_dominant_topic.Keywords:
    # Create a WordCloud object
    wordcloud = WordCloud(background_color="white", max_words=5000, contour_width=3, contour_color='steelblue')
    # Generate a word cloud
    wordcloud.generate(keywordsCommaSeperated)
    # Visualize the word cloud
    filename = 'keywords' + str(i)  + '.png'
    wordcloud.to_file(execution_directory + '\\result_images\\' + filename)
    i += 1
    if i == 25:
        break